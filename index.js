...
// Use the real Node binary rather than the Replit wrapper, which may point to
// a stale Nix store path when the runtime has been refreshed.
...
child.on("error", (error) => {
  console.error("[boot] Failed to start bot:", error.message);
  process.exit(1);
});
